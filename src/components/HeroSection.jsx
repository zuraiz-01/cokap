  ...
  return (
    <section className="hero">
      <div className="hero-copy">
        <p className="section-chip">The #1 Speaking Platform</p>
        <h1>The Best Partner to Reach Fluency</h1>
        <p>
          AI-backed speaking practice, guided tutors, and practical communication
          programs for real-world confidence.
        </p>
        <div className="hero-actions">
          <button className="btn btn-dark">Explore Class</button>
          <button className="btn btn-light">Get Consultation</button>
        </div>
      </div>
